...
public class MoviesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private interface References {
        String GENRE_ID = "REFERENCES " + Tables.GENRES + "(" + GenresDBHelper.GENRE_ID + ")";
        String MOVIE_ID = "REFERENCES " + Tables.MOVIES + "(" + MoviesDBHelper.MOVIE_ID + ")";
    }
    ...
    private void insertGenres(SQLiteDatabase db) {
        db.insert(Tables.GENRES, null, new Genres.Builder().id(28).name("Action").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(12).name("Adventure").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(16).name("Animation").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(35).name("Comedy").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(80).name("Crime").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(99).name("Documentary").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(18).name("Drama").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10751).name("Family").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(14).name("Fantasy").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10765).name("Foreign").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(36).name("History").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(27).name("Horror").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10402).name("Music").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(9648).name("Mystery").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10749).name("Romance").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(878).name("Science Fiction").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10770).name("TV Movie").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(53).name("Thriller").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(10752).name("War").build());
        db.insert(Tables.GENRES, null, new Genres.Builder().id(37).name("Western").build());
    }
